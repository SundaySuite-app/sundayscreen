# Contributing to SundayScreen

SundayScreen puts clock, timer, name picker, groups and traffic light on the classroom projector — fully offline. It is part of [Sunday Suite](https://sundaysuite.app) — a family of
