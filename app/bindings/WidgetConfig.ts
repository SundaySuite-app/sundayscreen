 ...
 */
lastResult: Array<Array<string>>, } | { "kind": "dice", count: number, lastRoll: Array<number>, } | { "kind": "trafficlight", active: TrafficColor, } | { "kind": "worksymbol", mode: WorkMode, } | { "kind": "agenda", source: AgendaSource, showTimes: boolean, manualItems: Array<ManualAgendaItem>, pinnedItemId: string | null, } | { "kind": "today", showLessons: boolean, showNotes: boolean, };
